...
// GraphLayers.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGraphLayersApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CGraphLayersApp::OnAppAbout)
...
// Создание CGraphLayersApp

CGraphLayersApp::CGraphLayersApp() noexcept
{
	...
	SetAppID(_T("GraphLayers.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CGraphLayersApp

CGraphLayersApp theApp;


// Инициализация CGraphLayersApp

BOOL CGraphLayersApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_GraphLayersTYPE,
		RUNTIME_CLASS(CGraphLayersDoc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(CGraphLayersView));
	if (!pDocTemplate)
		return FALSE;
...
int CGraphLayersApp::ExitInstance()
{
...
// Обработчики сообщений CGraphLayersApp
...
void CGraphLayersApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек CGraphLayersApp

void CGraphLayersApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CGraphLayersApp::LoadCustomState()
{
}

void CGraphLayersApp::SaveCustomState()
{
}
